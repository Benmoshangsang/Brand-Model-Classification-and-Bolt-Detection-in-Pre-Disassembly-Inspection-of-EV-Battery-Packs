# ========================
# Dual-Task Detector Config (Bolt-only, no brand head)
# ========================
_base_ = [
    ...
    dict(
        ...
        transforms=[
            [dict(type='RandomChoiceResize',
                  scales=[(480, 900), (512, 900), (544, 900),
...
work_dir = './work_dirs/cascade_rcnn_yolov12_backbone_bolt_only'
...
custom_imports = dict(
    imports=[
        ...
        # 'my_heads.shared_2fc_brand_head',  # 移除品牌头导入
        ...
        # 导入自定义 YOLOv12 backbone
        'my_backbones.yolov12',
    ],
