# ========================
# Dual-Task Detector Config (with brand top1/top5, no prefix, save_best fixed)
# ========================
_base_ = [
...
classes = [f'bolt{i+1}' for i in range(13)] 
...
train_dataloader = dict(
    ...
    dataset=dict(
        type=dataset_type,
        data_root=data_root,
        ann_file='annotations/train_clamped.json',
...
val_dataloader = dict(
    ...
    dataset=dict(
        type=dataset_type,
        data_root=data_root,
        ann_file='annotations/val_clamped.json',
...
val_evaluator = [
    dict(
        type='CocoMetric',
        ann_file=data_root + 'annotations/val_clamped.json',
        metric=['bbox'],
        format_only=False,
        backend_args=backend_args),
    dict(
